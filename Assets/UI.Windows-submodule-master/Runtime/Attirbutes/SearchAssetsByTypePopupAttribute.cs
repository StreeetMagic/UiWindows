...
namespace UnityEngine.UI.Windows.Utilities {
    ...
    public class SearchComponentsByTypePopupAttribute : PropertyAttribute {
        ...
        public SearchComponentsByTypePopupAttribute(System.Type baseType, string menuName = null, string innerField = null, string noneOption = "None", bool allowClassOverrides = false, bool singleOnly = false) {
